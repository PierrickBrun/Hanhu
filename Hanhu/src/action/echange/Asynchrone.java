...
public class Asynchrone extends UnicastRemoteObject implements _Asynchrone {
	 ...
	 */
	public Asynchrone(_Serveur serveur) throws RemoteException {this.serveur = serveur;}

	@Override
	public Object recevoir() {return reponse;}

	@Override
	public void envoyer(_Message message) throws RemoteException {reponse = serveur.getList((String) message.objet(),message.expediteur());}
